...
lm.pf <- pf(lm.summary$fstatistic[1], 
                lm.summary$fstatistic[2], 
                lm.summary$fstatistic[3],lower.tail = FALSE)
lm.steep.pf <- pf(lm.steep.summary$fstatistic[1], 
                        lm.steep.summary$fstatistic[2], 
                        lm.steep.summary$fstatistic[3],lower.tail = FALSE)
lm.flat.pf <- pf(lm.flat.summary$fstatistic[1], 
                        lm.flat.summary$fstatistic[2], 
                        lm.flat.summary$fstatistic[3],lower.tail = FALSE)

t00.2 <- round(lm$coefficients[1], 3)
t00.3 <- round(lm.steep$coefficients[1], 3)
t00.4 <- round(lm.flat$coefficients[1], 3)
t01.2 <- round(lm$coefficients[2], 3)
t01.3 <- round(lm.steep$coefficients[2], 3)
t01.4 <- round(lm.flat$coefficients[2], 3)
t1.2 <- round(lm.summary$sigma, 3)
t1.3 <- round(lm.steep.summary$sigma, 3)
t1.4 <- round(lm.flat.summary$sigma, 3)
t2.2 <- round(lm.summary$r.squared, 3)
t2.3 <- round(lm.steep.summary$r.squared, 3)
t2.4 <- round(lm.flat.summary$r.squared, 3)
t2b.2 <- round(lm.summary$adj.r.squared, 3)
t2b.3 <- round(lm.steep.summary$adj.r.squared, 3)
t2b.4 <- round(lm.flat.summary$adj.r.squared, 3)
t3.2 <- round(lm.summary$coefficients[1,4], 3)
t3.3 <- round(lm.steep.summary$coefficients[1,4], 3)
t3.4 <- round(lm.flat.summary$coefficients[1,4], 3)
t4.2 <- round(lm.summary$coefficients[2,4], 3)
t4.3 <- round(lm.steep.summary$coefficients[2,4], 3)
t4.4 <- round(lm.flat.summary$coefficients[2,4], 3)
t5.2 <- round(lm.summary$fstatistic[1])
t5.3 <- round(lm.steep.summary$fstatistic[1])
t5.4 <- round(lm.flat.summary$fstatistic[1])
```

Estimate | Linear Model | Linear Model Steep | Linear Model Flat
---------|--------------|-----------------------|----------------------
`r dimnames(lm.summary$coefficients)[[1]][1]` estimate | `r t00.2` | `r t00.3` | `r t00.4`
`r dimnames(lm.summary$coefficients)[[1]][2]` estimate | `r t01.2` | `r t01.3` | `r t01.4`
$\sigma_{\varepsilon}$ | `r t1.2` | `r t1.3` | `r t1.4`
$\rho^{2}$ | `r t2.2` | `r t2.3` | `r t2.4`
$\rho^{2} adjusted$ | `r t2b.2` | `r t2b.3` | `r t2b.4`
`r dimnames(lm.summary$coefficients)[[1]][1]` p-value | `r t3.2` | `r t3.3` | `r t3.4`
`r dimnames(lm.summary$coefficients)[[1]][2]` p-value | `r t4.2` | `r t4.3` | `r t4.4`
F-statistic | `r t5.2` | `r t5.3` | `r t5.4`
F p-value | `r round(lm.pf, 4)` | `r round(lm.steep.pf, 4)` | `r round(lm.flat.pf, 4)`
...
```{r q1.4-plot}
lm.steep.predict <- predict(lm.steep, 
                            data.frame(trainSteepInput=sample.data$Input), 
                            interval="prediction")
lm.flat.predict <- predict(lm.flat, 
                            data.frame(trainFlatInput=sample.data$Input), 
                            interval="prediction")
plot(sample.data$Input, sample.data$Output, type="p", pch=19)
lines(sample.data$Input, lm.steep.predict[,1], col="red", lwd=3)
lines(sample.data$Input, lm.flat.predict[,1], col="green", lwd=3)
```
