...
lm.raw.beta0.est <- lm.raw$coefficients[1]
lm.raw.beta1.est <- lm.raw$coefficients[2]
lm.raw.y.fit <- sample.data$Input * lm.raw.beta1.est + lm.raw.beta0.est
...
$Output = `r round(lm.raw.beta1.est, 3)` \cdot Input + `r round(lm.raw.beta0.est, 3)` + e$
